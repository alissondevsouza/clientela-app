...
const ERROR_TITLE = "Não foi possível carregar o pedido";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar os dados do pedido. Verifique sua conexão e tente novamente.";
...
// Error boundary do detalhe de pedido: o `error.tsx` da lista NÃO cobre as
