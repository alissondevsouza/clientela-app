...
const ERROR_TITLE = "Não foi possível carregar o produto";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar os dados do produto. Verifique sua conexão e tente novamente.";
...
// Error boundary do detalhe de produto: o `error.tsx` da lista NÃO cobre as
// rotas filhas, então o detalhe precisa do seu próprio. Client Component
