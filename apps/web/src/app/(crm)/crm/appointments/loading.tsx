...
const SKELETON_GROUP_KEYS = ["g1", "g2"] as const;
const SKELETON_CARD_KEYS = ["s1", "s2", "s3", "s4"] as const;

// Skeleton da listagem de compromissos (web.md: loading obrigatório em tela de
// dados). Espelha o layout real: header, abas, grupos de dia e grade de cards.
// Mobile-first: coluna única em ~375px, duas colunas a partir de sm.
export default function CrmAppointmentsLoading() {
  return (
