...
const ERROR_TITLE = "Não foi possível carregar a agenda";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar seus compromissos. Verifique sua conexão e tente novamente.";
const RETRY_LABEL = "Tentar novamente";

type AppointmentsErrorProps = {
...
// Error boundary da listagem (RF-17): Client Component obrigatório pelo Next.
// Mensagem pt-BR + retry via `reset()`.
export default function AppointmentsError({ reset }: AppointmentsErrorProps) {
  return (
