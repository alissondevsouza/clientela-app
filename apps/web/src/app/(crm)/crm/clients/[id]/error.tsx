...
const ERROR_TITLE = "Não foi possível carregar a cliente";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar os dados da cliente. Verifique sua conexão e tente novamente.";
...
// Error boundary do detalhe de cliente (RF-08): o `error.tsx` da lista NÃO cobre
...
export default function ClientDetailError({ reset }: ClientDetailErrorProps) {
  return (
