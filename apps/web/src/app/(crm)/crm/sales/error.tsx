...
const ERROR_TITLE = "Não foi possível carregar as vendas";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar suas vendas. Verifique sua conexão e tente novamente.";
...
// Error boundary da listagem (RF-08): Client Component obrigatório pelo Next.
// Mensagem pt-BR + retry via `reset()`.
export default function SalesError({ reset }: SalesErrorProps) {
  return (
