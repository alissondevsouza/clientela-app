...
const ERROR_TITLE = "Não foi possível carregar a venda";
const ERROR_DESCRIPTION =
  "Ocorreu um problema ao buscar os dados da venda. Verifique sua conexão e tente novamente.";
const RETRY_LABEL = "Tentar novamente";

type SaleDetailErrorProps = {
...
// Error boundary do detalhe de venda: o `error.tsx` da lista NÃO cobre as rotas
// filhas, então o detalhe precisa do seu próprio. Client Component obrigatório
// pelo Next. Mensagem pt-BR + retry via `reset()`.
export default function SaleDetailError({ reset }: SaleDetailErrorProps) {
  return (
