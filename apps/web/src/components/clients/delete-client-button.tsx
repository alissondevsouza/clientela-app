...
import { deleteClientAction } from "@/app/(crm)/crm/clients/actions";
import { Button } from "@/components/ui/button";

const DELETE_LABEL = "Excluir cliente";
...
// Exclusão em dois passos (RF-08/LGPD): o 1º clique NÃO exclui — troca para uma
// confirmação explícita, evitando exclusão acidental de dado pessoal. No sucesso a
// action redireciona para a lista; falha vira mensagem pt-BR em `role="alert"`.
