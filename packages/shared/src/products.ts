...
// Contrato de criação: estoque default 0 e limiar default 1 quando ausentes.
...
// PATCH parcial (sem os defaults): toda chave opcional; só `brandCode` aceita
// `null` (limpar) — os demais são não-nuláveis. O refine barra o body vazio.
